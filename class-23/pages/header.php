    ...
    <div class="px-3 py-2 text-bg-dark">
      <div class="container">
        ...
        <a href="#" class='navbar-logo d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none'>
            <img src="asset/images/logo.png" alt="" width='100' class='img-fluid bi me-2'>
          </a>
            ...
            <?php $pageLabel='Categories'; ?>
                                ...
                                <ul class="dropdown-menu">
                                    <?php foreach($categories as $category){ ?>
                                        <li><a href="action.php?page=<?php echo $pageLabel; ?>&&id=<?php echo $category['id']; ?>" class='dropdown-item'><?php echo $category['name'];?></a></li>
                                    <?php }?>
                                </ul>
                            </li>
            <li>
            ...
            <?php $pageLabel='Brands'; ?>
                                ...
                                <ul class="dropdown-menu">
                                    <?php foreach($brands as $brand){ ?>
                                        <li><a href="action.php?page=<?php echo $pageLabel; ?>&&id=<?php echo $brand['id']; ?>" class='dropdown-item'><?php echo $brand['name'];?></a></li>
                                    <?php }?>
                                </ul>
                            </li>
            <li>
