        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
               <div class="container">     
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li><a href="action.php?page=Products" class='nav-link'>Products</a></li>
                            <li class="dropdown">
        ...
        <a href="#" class='navbar-logo d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none'>
          ...
          <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            ...
            <?php $pageLabel='Category'; ?>
                                ...
                                <ul class="dropdown-menu">
                                    <?php foreach($categories as $category){ ?>
                                        <li><a href="action.php?page=<?php echo $pageLabel; ?>&&CategoryId=<?php echo $category['id']; ?>" class='dropdown-item'><?php echo $category['name'];?></a></li>
                                    <?php }?>
                                </ul>
                            </li>
            <li>
