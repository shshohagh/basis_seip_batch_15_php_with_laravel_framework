        ...
        @endif
                <form action="{{ route('login') }}" method="post" role="form" class="text-start">
                  ...
                  <div class="input-group input-group-outline mb-3">
                    ...
                    <input type="password" name="password" value="11111111" class="form-control">
                  </div>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
              <div class="copyright text-center text-sm text-white text-lg-start">
                ...
                <a href="#" class="font-weight-bold text-white" target="_blank">SKS IT FIRM<?php //echo $title; ?></a>
                for a better web.
              </div>
            </div>
            <div class="col-12 col-md-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="#" class="nav-link text-white" target="_blank">www.sksitfirm.net<?php //echo $url; ?></a>
                </li>
