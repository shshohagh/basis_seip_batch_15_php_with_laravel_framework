                        ...
                        <div class="card-body">
                            <form action="{{route('save')}}" class="form" method='post' enctype='multipart/form-data'>
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <textarea name="address" id="" class="form-control" cols="40" rows="5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt ea sapiente ipsa omnis alias mollitia! Accusantium est, eum aliquid earum dolorem similique voluptates quam, commodi consequuntur error dolorum doloremque necessitatibus.</textarea>
                                </div>
                                <div class="col-md-12 mb-2">
