            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card border-info">
                        ...
                        <div class="card-body">
                            <form action="{{route('update')}}" class="form-control" method='post' enctype='multipart/form-data'>
                                @csrf
                                ...
                                <div class="col-md-3">
                                    ...
                                    <textarea name="address" id="" cols="30" rows="5">{{$student->address}}</textarea>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <img src="{{asset($student->image)}}" class="img-fluid w-50" alt="">
                                </div>
