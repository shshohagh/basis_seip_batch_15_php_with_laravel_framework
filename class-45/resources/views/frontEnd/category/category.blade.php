        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9" data-aos="fade-up">
                    ...
                    <h3 class="category-title">Category: {{ $categoryName->category_name }}</h3>
                    @if(count($categoryWiseBlogs)>0)
                    @foreach($categoryWiseBlogs as $blog)
                    <div class="d-md-flex post-entry-2 half">
                        <a href="{{ route('blog.detail', ['slug'=>$blog->slug]) }}" class="me-4 thumbnail">
